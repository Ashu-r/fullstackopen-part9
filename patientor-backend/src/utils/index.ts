...
const parseDiagnosis = (diagnosisCodes: any): diagnosisCodes is Array<Diagnosis['code']> => {
...
const isOccupationalHealthcareEntry = (entry: any): entry is newOccupationalHealthcareEntry => {
...
export const toNewPatient = ({ ssn, name, dateOfBirth, gender, occupation, entries }: PatientFields): NewPatient => {
